...
function generateTable() {
  if (score.value.trim() < 5000) {
    ...
    let panjShanbe1 = {
      ...
      eghtesad: `اقتصاد (${eghtesadTitle.value}) از صفحه ${eghtesadStartPage.value} تا صفحه ${eghtesadEndPage.value} (1:30 ساعت مطالعه)`,
      totalTime: `7:30`,
    };
    let jome1 = {
      math: `${
    ...
    let doShanbe2 = {
      ...
      joghrafi: `جغرافیای ایران (${joghrafiTitle.value}) ${joghrafiModule.value} (45 دقیقه حل تست)`,
      totalTime: `4:30`,
    };
    let seShanbe2 = {
      dailyReading: "روزخوانی (1 ساعت)",
    ...
    let panjShanbe1 = {
      ...
      eghtesad: `اقتصاد (${eghtesadTitle.value}) از صفحه ${eghtesadStartPage.value} تا صفحه ${eghtesadEndPage.value} (2 ساعت مطالعه)`,
      totalTime: `9`,
    };
    let jome1 = {
      math: `${
    ...
    let panjShanbe1 = {
      ...
      eghtesad: `اقتصاد (${eghtesadTitle.value}) از صفحه ${eghtesadStartPage.value} تا صفحه ${eghtesadEndPage.value} (2:30 ساعت مطالعه)`,
      totalTime: `10:30`,
    };
    let jome1 = {
      math: `${
    ...
    let doShanbe2 = {
      ...
      joghrafi: `جغرافیای ایران (${joghrafiTitle.value}) ${joghrafiModule.value} (1 ساعت حل تست)`,
      totalTime: `6:15`,
    };
    let seShanbe2 = {
      dailyReading: "روزخوانی (1:15 ساعت)",
    ...
    let panjShanbe1 = {
      ...
      eghtesad: `اقتصاد (${eghtesadTitle.value}) از صفحه ${eghtesadStartPage.value} تا صفحه ${eghtesadEndPage.value} (3 ساعت مطالعه)`,
      totalTime: `12:30`,
    };
    let jome1 = {
      math: `${
      ...
      mantegh: `منطق (${manteghTitle.value}) از صفحه ${manteghStartPage.value} تا صفحه ${manteghEndPage.value} (4 ساعت مطالعه)`,
      revising: `مرور و جمع بندی مطالب (2:30 ساعت)`,
      totalTime: `13:30`,
    };
    let shanbe2 = {
    ...
    let doShanbe2 = {
      ...
      joghrafi: `جغرافیای ایران (${joghrafiTitle.value}) ${joghrafiModule.value} (1:15 ساعت حل تست)`,
      totalTime: `7:15`,
    };
    let seShanbe2 = {
      dailyReading: "روزخوانی (1:15 ساعت)",
    ...
    let chaharShanbe2 = {
      ...
      math: `ریاضی و آمار (${mathTitle.value}) ${mathModule.value} (1 ساعت حل تست)`,
      adabiat: `علوم و فنون ادبی (${adabiatTitle.value}) ${adabiatModule.value} (1 ساعت حل تست)`,
      eghtesad: `اقتصاد (${eghtesadTitle.value}) ${eghtesadModule.value} (1:45 ساعت حل تست)`,
